...
public class PostServiceTests
{
    ...
    public async Task GetPostById_WithExistingPost_ReturnsSuccess()
    {
        ...
        _mockPostRepository
            .Setup(r => r.GetFatPostById(_testPostId))
            .ReturnsAsync(post);
    ...
    {
        // Arrange
        var post = CreateTestPostWithVote(_testPostId, _testUserId, Guid.NewGuid(), VoteType.Upvote);
    ...
    public async Task CreatePost_WithValidData_ReturnsSuccess()
    {
        ...
        _mockTagRepository
            .Setup(r => r.GetTagsByIds(createDto.TagIds))
            .ReturnsAsync(tags);
    ...
    public async Task UpdatePost_WithNewTags_UpdatesTags()
    {
        ...
        var post = CreateTestFatPost(_testPostId, _testUserId, "Test Post");
        post.Tags = new List<Tag> { new Tag { Id = oldTagId, Name = "OldTag" } };
        ...
        var newTags = new List<Tag> { new Tag { Id = newTagId, Name = "NewTag" } };
        ...
        _mockTagRepository
            .Setup(r => r.GetTagsByIds(updateDto.TagIds))
    ...
    public async Task VotePost_WithNoExistingVote_CreatesNewVote()
    {
        ...
        _mockPostRepository
            .Setup(r => r.GetSlimPostbyId(_testPostId))
            .ReturnsAsync(post);
        ...
        _mockPostVoteRepository
            .Setup(r => r.Add(It.IsAny<PostVote>()))
            .Returns(Task.CompletedTask);
